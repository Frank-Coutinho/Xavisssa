...
namespace Xavissa.Frontend.ViewModels
{
    public class LoginViewModel : ViewModelBase
    {
        ...
        private readonly IWorkspaceSchemaInitializer _workspaceSchema;
        ...
        public LoginViewModel(
            ...
            IWorkspaceSchemaInitializer workspaceSchema)
        {
            ...
            _workspaceSchema = workspaceSchema ?? throw new ArgumentNullException(nameof(workspaceSchema));
        ...
        {
            await _workspaceSchema.EnsureAsync();
        }
